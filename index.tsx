...
import { InputProps, OTPInputViewState } from 'saymee-react-native-otp-input';;
...
export default class OTPInputView extends Component<InputProps, OTPInputViewState> {
    ...
    focusField = (index: number) => {
        if (index < this.fields.length) {
            setTimeout(()=>(this.fields[index] as TextInput).focus(),Platform.OS=='android'?125:undefined);
